...
AdharNo=form.getvalue("AdharNo")
PanNo=form.getvalue("PanNo")
Registrationdate=form.getvalue("Registrationdate")
Certificationdate=form.getvalue("Certificationdate")
Shippingaddress=form.getvalue("Shippingaddress")
...
if conn.is_connected():
    ...
    query="INSERT INTO shopdetails(ShopName,OwnerName,Email,Password,MobileNo,Address,AdharNo,PanNo,Registrationdate,Certificationdate,Shippingaddress) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
    val=(ShopName,OwnerName,Email,Password,MobileNo,Address,AdharNo,PanNo,Registrationdate,Certificationdate,Shippingaddress)
