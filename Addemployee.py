...
if conn.is_connected():
    ...
    query="INSERT INTO addemployee(id,Name,Phone,Address,AdharNo,PanNo,Department,AccountNo) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)"
    val=(id,Name,Phone,Address,AdharNo,PanNo,Department,AccountNo)
    ...
    print('<thead> <tr> <th scope="col">id</th><th scope="col">Name</th><th scope="col">Phone</th><th scope="col">Address</th><th scope="col">AdharNo</th><th scope="col">PanNo</th><th scope="col">Department</th><th scope="col">AccountNo</th>  </tr> </thead>') 
    
    print('<tbody> ')
    for x in result:
        print(f'<tr> <td scope="row">{x[0]}</td> <td>{x[1]}</td> <td>{x[2]}</td> <td>{x[3]}</td> <td>{x[4]}</td> <td>{x[5]}</td> <td>{x[6]}</td> <td>{x[7]}</td>')
        print('</tr>')
