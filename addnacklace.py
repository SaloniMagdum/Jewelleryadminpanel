...
if conn.is_connected():
    ...
    query = "INSERT INTO addneacklacegold(Jewelleryname,Category,Weight,Quantity,Description,GST,Totalprice,Stock) VALUES (%s,%s, %s, %s ,%s, %s, %s, %s)"
    ...
    query="SELECT * FROM addneacklacegold"
