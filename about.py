...
<!-- Mirrored from demo.dashboardpack.com/analytic-html/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Jul 2022 10:22:11 GMT -->
...
<input type="Password" id="Password" name="Password" placeholder="Password">
 ...
 <a href="#" class="btn_1 full_width text-center"><button style='text-decoration:none' href=''>Log in </button></a>
