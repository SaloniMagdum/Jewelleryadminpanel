...
Warrenty=form.getvalue("Warrenty")
...
if conn.is_connected():
    ...
    query="INSERT INTO addproduct(id,Name,Category,Department,Weight,Price,GST,Warrenty) VALUES (%s, %s, %s,%s, %s, %s, %s, %s)"
    val=(id,Name,Category,Department,Weight,Price,GST,Warrenty)
    ...
    print('<thead> <tr> <th scope="col">id</th><th scope="col">Name</th><th scope="col">Category</th><th scope="col">Department</th><th scope="col">Weight</th><th scope="col">Price</th><th scope="col">GST</th><th scope="col">Warrenty</th> </tr> </thead>') 
