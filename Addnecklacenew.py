...
if conn.is_connected():
    ...
    query = "INSERT INTO addnecklacenew(Jewelleryname,Category,Weight,Quantity,Description,GST,Totalprice,Stock) VALUES (%s,%s, %s, %s ,%s, %s, %s, %s)"
    ...
    query="SELECT * FROM addnecklacenew"
