...
if conn.is_connected():
    ...
    query = "INSERT INTO addbanglenk(Jewelleryname,Category,Weight,Quantity,Description,GST,Totalprice,Stock) VALUES (%s,%s, %s, %s ,%s, %s, %s, %s)"
